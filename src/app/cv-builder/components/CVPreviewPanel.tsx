...
const fontOptions: {
  ...
  },
  {
    ...
    label: 'Calibri',
    preview: 'Aa',
    fontFamily: "'Calibri', 'Carlito', 'Trebuchet MS', sans-serif",
  },
  {
    value: 'mono',
    label: 'Mono',
...
function TemplateRenderer({
  ...
  switch (cvData.templateId) {
    ...
    case 'clasico':
      return <CVTemplateClasico cvData={cvData} />;
...
export default function CVPreviewPanel({
  ...
  const numericSize =
    rawFontSize && /^\d+$/.test(rawFontSize)
  ...
  return (
    <div className="flex flex-col h-full">
        ...
        <div className="flex gap-2 flex-wrap items-center">
          ...
          >
            <div
              ...
              style={{
                backgroundColor: colorPresets.some(
          ...
          >
            ...
            <div
              style={{
                ...
                transform:
                  'scale(var(--cv-preview-scale, 0.60))',
              }}
      ...
      <style>{`
        ...
        @media (min-width: 1024px) {
          .cv-preview-spacer {
            height: calc(1123px * 0.62 + 8px);
          }
        }

        @media (min-width: 1280px) {
          .cv-preview-spacer {
            height: calc(1123px * 0.68 + 8px);
          }
        }

        @media (min-width: 1536px) {
          .cv-preview-spacer {
            height: calc(1123px * 0.74 + 8px);
          }
        }
        ...
        #cv-preview-root .cv-rich-content p {
          margin: 0.15em 0;
        }

        #cv-preview-root .cv-rich-content strong {
          font-weight: 700;
        }

        #cv-preview-root .cv-rich-content em {
          font-style: italic;
        }

        #cv-preview-root .cv-rich-content u {
          text-decoration: underline;
        }

        #cv-preview-root .cv-rich-content a {
          color: inherit;
          text-decoration: underline;
        }
